...
public class OpinionController {
    ...
    public ResponseEntity<OpinionResource> createOpinionForPublication(
            @PathVariable Long publicationId,
            @PathVariable Long fanaticId,
            @RequestBody CreateOpinionResource resource){
    ...
    public ResponseEntity<OpinionResource> createOpinionForEvent(
            @PathVariable Long eventId,
            @PathVariable Long fanaticId,
            @RequestBody CreateOpinionResource resource){
        mapping.getConfiguration().setMatchingStrategy(MatchingStrategies.STRICT);
    ...
    public ResponseEntity<?> deleteOpinionForPublication(
            @PathVariable Long publicationId,
            @PathVariable Long fanaticId){
    ...
    public ResponseEntity<?> deleteOpinionForEvent(
            @PathVariable Long eventId,
            @PathVariable Long fanaticId){
    ...
    public ResponseEntity<OpinionResource> updateOpinionForPublication(
            @PathVariable Long publicationId,
            @PathVariable Long fanaticId,
            @RequestBody CreateOpinionResource resource){
        Opinion opinion = mapping.map(resource, Opinion.class);
    ...
    public ResponseEntity<OpinionResource> updateOpinionForEvent(
            @PathVariable Long eventId,
            @PathVariable Long fanaticId,
            @RequestBody CreateOpinionResource resource){
        Opinion opinion = mapping.map(resource, Opinion.class);
